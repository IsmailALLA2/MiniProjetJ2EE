        ...
        <div class="ml-auto">
          <nav class="site-navigation position-relative text-right" role="navigation">
            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
              <li><a href="/admin/home.jsp" class="nav-link">Home</a></li>
              <li><a href="/admin/add.jsp" class="nav-link">add</a></li>
              <li class="active"><a href="/admin/users.jsp" class="nav-link">Users</a></li>
              <li><a href="/admin/archive.jsp" class="nav-link">Archive</a></li>
  ...
  <div class="formulaire">
    <div class="signup-container" >
      <div class="left-container">
        <h1 style="color: rgb(255, 255, 213);margin-top: 40%;font-family: cursive;">
          ...
          <form action="/UsersServlet" method="post">
            <div class="set">
              <div class="pets-breed">
                <label for="pets-breed">First name </label>
                <input id="pets-breed" placeholder="First name " name="firstName" type="text" required></input>
              </div>

              <div class="pets-breed">
                <label for="pets-breed">Second name </label>
                <input id="pets-breed" placeholder="Second name" name="lastName" type="text" required></input>
              </div>
            </div>
            <div class="set">
              <div class="pets-breed">
                <label for="pets-breed">Email </label>
                <input id="pets-breed" placeholder="Email" name="email" type="text" required></input>
              </div>

              <div class="pets-breed">
                <label for="pets-breed">Password </label>
                <input id="pets-breed" placeholder="Password" name="password" required type="password"></input>
              </div>
            </div>

            <input type="submit" value="Add" id="modify">
          </form>
        </header>
      </div>
    </div>
        ...
        <div class="col-md-12">
          <div class=" pt-5">
            <p>
              ...
              </script> This project is made with<i class="icon-heart"
                                                    aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">ESTE Students</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
        </div>
