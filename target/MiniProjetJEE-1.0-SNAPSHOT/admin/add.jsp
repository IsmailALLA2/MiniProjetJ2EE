        ...
        <div class="ml-auto">
          <nav class="site-navigation position-relative text-right" role="navigation">
            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
              ...
              <li  class="active"><a href="/admin/add.jsp" class="nav-link">Add</a></li>
              <li><a href="/admin/users.jsp" class="nav-link">Users</a></li>
    ...
    <div class="signup-container" >
      ...
      <div class="right-container">
        <header>
          ...
          <form action="/MatchsServlet" method="post">
            <div class="set">
              <div class="pets-breed">
                <label for="pets-breed">Team 1 </label>
                <input id="pets-breed" placeholder="Team 1" name="team1" type="text" required></input>
              </div>

              <div class="pets-breed">
                <label for="pets-breed">Team 2 </label>
                <input id="pets-breed" placeholder="Team 2" name="team2" type="text" required></input>
              </div>
            </div>
            <div class="set">
              <div class="pets-breed">
                <label for="pets-breed">Stadium </label>
                <input id="pets-breed" placeholder="Stadium" name="place" type="text" required></input>
              </div>

              <div class="pets-breed">
                <label for="pets-breed">Date </label>
                <input id="pets-breed" name="date" type="datetime-local" required></input>
              </div>
            </div>
